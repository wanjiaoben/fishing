const lines = [
  ...
  "    const paypalStatus = document.getElementById('paypal-status'); if (paypalStatus && debugEnabled) { paypalStatus.hidden = false; paypalStatus.textContent = 'PayPal buttons ready.'; }",
  "  }",
